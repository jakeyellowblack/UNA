...
<div class="u-content">
	...
	<h1 class="h2 mb-2">Lista de Movimientos de Reformulación</h1>
	        ...
	        <div class="card mb-5">
		        ...
		        <header class="card-header">
			        <h2 class="h4 card-header-title">Movimientos de Reformulación</h2>  
	        	</header>
                
		        <!-- Crad Body -->
	          <div class="card-body pt-0">
                                            <div align="right">
                <a href="{{ route('reformulacion.reformulacion') }}" class="btn btn-primary my-20 my-sm-0" role="button">Generar reporte</a>
                          </div>              
				 ...
				 @foreach($movreformulacion as $mov)
			            ...
			            <tbody>
				          <tr>
								          ...
								          <td class="font-weight-semi-bold">{{ $mov->reformulacion->title }}</td>
			...
			<div class="modal-dialog" role="document">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
                      ...
                      <form action="{{route('refmovimiento.update', 'test')}}" method="post">
                      		@method('PUT')
      						@csrf
			...
			<div class="modal-dialog" role="document">
				...
				<div class="modal-content">
					...
					<div class="modal-header">
                      ...
                      <form action="{{route('refmovimiento.destroy', 'test')}}" method="post">
                      		@method('DELETE')
      						@csrf
					<div class="modal-body">
